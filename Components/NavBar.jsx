          ...
          {!currentAccount && (
            <ul className="flex items-center hidden space-x-8 lg:flex">
              ...
              <button
                ...
                className="flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition-all duration-300 rounded-md shadow-lg bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
